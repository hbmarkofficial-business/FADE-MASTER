  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | FADE MASTER</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop FADE MASTER in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="FADE MASTER | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="FADE MASTER | Premium Barbershop Berlin" />
        <meta
